...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/admin/company/about_us/{id}/delete": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/admin/company/about_us/{id}/update": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/admin/product/product/{id}/update": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/admin/product/product_media/create": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/admin/product/product_media/list": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/admin/product/product_media/{id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/admin/product/product_media/{id}/delete": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/admin/product/product_media/{id}/update": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
